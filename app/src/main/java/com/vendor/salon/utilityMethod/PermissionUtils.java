...
import com.vendor.salon.FragmentCallBack;
import com.vendor.salon.FunctionsClass;
...
public class PermissionUtils {
    ...
    public void showCameraPermissionDailog(String message)
    {
        ...
        {
            permissionStatusList.add(FunctionsClass.getPermissionStatus(activity,keyStr));
        }

        if (permissionStatusList.contains("denied"))
        {
            FunctionsClass.showDoubleButtonAlert(activity, activity.getString(R.string.permission_alert),message,
